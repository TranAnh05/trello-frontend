...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  /**
   * memberIds in card will be a subset of memberIds in board, so we can filter the board members to get the card members
   * solution: based on FE_allUsers and cardMemberIds, we create a array FE_CardMembers
   */
  ...
  const handleUpdateCardMembers = (user) => {
    // create a variable incomingMemberInfo to send to BE with two infomations: userId and action (add or remove)
