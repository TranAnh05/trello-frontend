export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'VanAnhDev MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://images.unsplash.com/photo-1783181155212-361c2aabfca7?q=80&w=1334&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      },
      {
        ...
        // Xu ly dndkit column rong. Phan nay do FE lam (khong lien quan toi BE)
        // Cau truc id cua card nay nhu sau: columnId-placeholder-card
